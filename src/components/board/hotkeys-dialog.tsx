    ...
    () => [
      {
        ...
        items: [
          ...
          { keys: ['5'], description: 'Ellipse tool' },
          { keys: ['6'], description: 'Text tool' },
          { keys: ['7'], description: 'Eraser tool' },
          { keys: ['8'], description: 'Laser pointer tool' },
        ],
      },
      {
        category: 'Edit',
        items: [
          ...
          { keys: ['Hold', 'Shift'], description: 'Constrain while drawing' },
        ],
      },
      {
        category: 'Canvas',
        items: [
          ...
          { keys: [modKey, '+', 'Scroll'], description: 'Zoom canvas' },
        ],
      },
      {
        ...
        items: [
          ...
          { keys: [modKey, shiftKey, 'E'], description: 'Export image' },
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>Quick reference for the whiteboard</DialogDescription>
        </DialogHeader>
