...
export function Whiteboard({ roomId }: WhiteboardProps) {
    ...
    useEffect(() => {
        ...
        const initializeCollaboration = async () => {
            ...
            if (encryptionKey) {
                const initialElements = await collab.getElementsAsync();
                if (mounted) setElements(initialElements);
            } else {
                setElements(collab.getElements());
            }

            // Subscribe to element changes
            unsubElements = collab.onElementsChange((newElements) => {
                if (mounted) setElements(newElements);
            });
